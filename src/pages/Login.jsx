    ...
    <div className='fixed w-full px-4 py-24 z-20'>
      <div className='max-w-[450px] h-[600px] mx-auto bg-black/80 rounded-lg'>
        ...
        onChange={(e)=>setPassword(e.target.value)}
         ...
         <button className='bg-red-600 py-3 my-6 rounded'>Login</button>
        <div className='flex justify-between items-center text-grey-600'>
        ...
        <p className='my-4'>
          <span className='text-grey-600 mr-2'>
            New to Netflix?
            </span>
